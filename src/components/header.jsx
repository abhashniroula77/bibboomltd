...
const Header = () => {
    ...
    return (
        <div className="fixed flex w-full top-0 h-[48px] items-center justify-between px-4 bg-white/90 backdrop-blur z-50 ">
            {/* Logo */}
            <a href="#hero" className="relative flex size-[10rem]">
            ...
            <div className="sm:flex hidden gap-4 items-center justify-center">
                ...
                <a
                    ...
                    className="px-2 relative py-1 flex items-center justify-center tracking-[-0.06em] bg-blue-600 rounded-md hover:opacity-80 duration-300 text-white overflow-hidden group"
                    href="#cta"
                >
            ...
            <div className="sm:hidden flex items-center justify-center gap-4">
                <a onClick={handleConnectClick} className="px-2 py-1 flex items-center justify-center tracking-[-0.06em] bg-blue-600 rounded-md hover:opacity-80 duration-300 text-white" href="#cta">
                    {handling && <Loader className="animate-spin absolute" size={20} />}
